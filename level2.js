function level2F(){
    ...
    text("You need to fetch the seed, watering can and the fertiliser for the plant to grow!. ",bot.x,camera.y + 300)

    if(bot.isTouching(portal)){
        portal.rotationSpeed = portal.rotationSpeed + 0.5
        bot.velocityX = 0
        bot.velocityY = 0
        if(portal.rotationSpeed === 40){
            bot.x = 50
            bot.y = height/2 + 50
            portal.rotationSpeed = 3
        }
    }
